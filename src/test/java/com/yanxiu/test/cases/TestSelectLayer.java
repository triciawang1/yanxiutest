...
public class TestSelectLayer extends BaseCase{
	@BeforeMethod
	public void setUpExamine() throws UnsupportedEncodingException {
		...
		MocoServer.response("trainlistwithlayer.json", "/trainlist");
	...
	public void testLayerInformation(){
		app.layerPage().pageDown();
	}
	
	@Test
	@TakeScreenshotAndAssert
	public void testSelectLayer(){
		app.layerPage().selectLayer();
	}
	
	@Test
	@TakeScreenshotAndAssert
	public void testCancelSelectLayer(){
		app.layerPage().cancelSelectLayer();
	}
	
	@Test
	@TakeScreenshotAndAssert
	public void testUpdateChoice(){
		app.layerPage().updateChoice();
	}
}
